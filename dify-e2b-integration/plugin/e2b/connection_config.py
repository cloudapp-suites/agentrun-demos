...
class ConnectionConfig:
    ...
    def get_sandbox_url(self, sandbox_id: str, sandbox_domain: str) -> str:
        if self._sandbox_url:
            # Self-hosted mode: embed sandbox ID in URL path so that all
            # requests (including signed file URLs) carry routing info.
            return f"{self._sandbox_url.rstrip('/')}/sandbox/{sandbox_id}"
